...
When contributing to `webezyio`, please first discuss the change you wish to make via issue,
email, or any other method with the owners of `webezyio` before making a change. 
...
```sh
sphinx-apidoc -o source ../webezyio
...
> __Note:__ make sure to edit `webezyio/config.py` and reset all custom configuration before releasing the package
