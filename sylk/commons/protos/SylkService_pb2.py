...
class SylkService(_message.Message):
	...
	def __init__(self, uri=str, name=str, full_name=str, description=str, methods=List[SylkMethod__pb2.SylkMethod], type=str, dependencies=List[str], extensions=Dict[str,google_dot_protobuf_dot_struct__pb2.Struct]):
		"""
		Attributes:
		----------
		uri : str
...
class SylkServiceDisplay(_message.Message):
	"""webezyio generated message [sylk.SylkService.v1.SylkServiceDisplay]
	...
	def __init__(self, service=SylkService, created_at=google_dot_protobuf_dot_timestamp__pb2.Timestamp, updated_at=google_dot_protobuf_dot_timestamp__pb2.Timestamp):
		"""
		Attributes:
		----------
		service : SylkService
