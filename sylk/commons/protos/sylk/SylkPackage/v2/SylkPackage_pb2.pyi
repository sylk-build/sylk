from sylk.SylkMessage.v2 import SylkMessage_pb2 as _SylkMessage_pb2
...
class SylkPackage(_message.Message):
    __slots__ = ["services", "messages", "extensions", "type", "description", "enums", "package", "dependencies", "name", "uri"]
    ...
    services: _containers.RepeatedCompositeFieldContainer[_SylkService_pb2.SylkService]
    ...
    name: str
    uri: str
    def __init__(self, services: _Optional[_Iterable[_Union[_SylkService_pb2.SylkService, _Mapping]]] = ..., messages: _Optional[_Iterable[_Union[_SylkMessage_pb2.SylkMessage, _Mapping]]] = ..., extensions: _Optional[_Mapping[str, _struct_pb2.Struct]] = ..., type: _Optional[str] = ..., description: _Optional[str] = ..., enums: _Optional[_Iterable[_Union[_SylkEnum_pb2.SylkEnum, _Mapping]]] = ..., package: _Optional[str] = ..., dependencies: _Optional[_Iterable[str]] = ..., name: _Optional[str] = ..., uri: _Optional[str] = ...) -> None: ...
