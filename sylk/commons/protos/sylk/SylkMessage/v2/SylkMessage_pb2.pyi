...
class SylkMessage(_message.Message):
    __slots__ = ["extension_type", "name", "uri", "extensions", "full_name", "type", "description", "kind", "fields", "tag", "inlines"]
    ...
    INLINES_FIELD_NUMBER: _ClassVar[int]
...
class SylkMessageDisplay(_message.Message):
    ...
    id: str
    def __init__(self, updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., message: _Optional[_Union[SylkMessage, _Mapping]] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., id: _Optional[str] = ...) -> None: ...
