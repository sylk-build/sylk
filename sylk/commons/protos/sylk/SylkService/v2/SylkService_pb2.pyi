...
class SylkService(_message.Message):
    __slots__ = ["dependencies", "description", "uri", "name", "full_name", "type", "methods", "extensions", "tag"]
    ...
    tag: str
    def __init__(self, dependencies: _Optional[_Iterable[str]] = ..., description: _Optional[str] = ..., uri: _Optional[str] = ..., name: _Optional[str] = ..., full_name: _Optional[str] = ..., type: _Optional[str] = ..., methods: _Optional[_Iterable[_Union[_SylkMethod_pb2.SylkMethod, _Mapping]]] = ..., extensions: _Optional[_Mapping[str, _struct_pb2.Struct]] = ..., tag: _Optional[str] = ...) -> None: ...
