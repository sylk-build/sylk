...
def add_EnumsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetEnum': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEnum,
                    request_deserializer=sylk_dot_SylkApi_dot_v1_dot_SylkApi__pb2.GetEnumRequest.FromString,
                    response_serializer=sylk_dot_SylkApi_dot_v1_dot_SylkApi__pb2.GetEnumResponse.SerializeToString,
            ),
            'UpdateEnum': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateEnum,
                    request_deserializer=sylk_dot_SylkApi_dot_v1_dot_SylkApi__pb2.UpdateEnumRequest.FromString,
                    response_serializer=sylk_dot_SylkApi_dot_v1_dot_SylkApi__pb2.UpdateEnumResponse.SerializeToString,
            ),
            'DeleteEnum': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteEnum,
                    request_deserializer=sylk_dot_SylkApi_dot_v1_dot_SylkApi__pb2.DeleteEnumRequest.FromString,
                    response_serializer=sylk_dot_SylkApi_dot_v1_dot_SylkApi__pb2.DeleteEnumResponse.SerializeToString,
            ),
