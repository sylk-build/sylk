...
class EnumsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateEnum = channel.unary_unary(
                ...
                response_deserializer=SylkApi__pb2.UpdateEnumResponse.FromString,
                )
...
def add_EnumsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateEnum': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=SylkApi__pb2.UpdateEnumResponse.SerializeToString,
            ),
...
class Enums(object):
    ...
    def UpdateEnum(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Enums/UpdateEnum',
            SylkApi__pb2.UpdateEnumRequest.SerializeToString,
            SylkApi__pb2.UpdateEnumResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
