...
class EnumValuesStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEnumValue = channel.unary_unary(
                ...
                request_serializer=SylkApi__pb2.GetEnumValueRequest.SerializeToString,
                response_deserializer=SylkApi__pb2.GetEnumValueResponse.FromString,
                )
...
def add_EnumValuesServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetEnumValue': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=SylkApi__pb2.GetEnumValueRequest.FromString,
                    response_serializer=SylkApi__pb2.GetEnumValueResponse.SerializeToString,
            ),
...
class EnumValues(object):
    ...
    def GetEnumValue(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/EnumValues/GetEnumValue',
            SylkApi__pb2.GetEnumValueRequest.SerializeToString,
            SylkApi__pb2.GetEnumValueResponse.FromString,
    ...
    def CreateEnumValue(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/EnumValues/CreateEnumValue',
            SylkApi__pb2.CreateEnumValueRequest.SerializeToString,
            SylkApi__pb2.CreateEnumValueResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
